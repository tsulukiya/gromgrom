...
//        Room room1 = new Room(4, 1200.5, true, false, new Date(), new Hotel(3314));
//        Room room2 = new Room(2, 980.5, true, false, new Date(), new Hotel(2046));
//        Room room3 = new Room(1, 1000.5, false, false, new Date(), new Hotel(2685));
